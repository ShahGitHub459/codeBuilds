...
import Models.mediaMarketObjects;
...
public class TestMedia {
	...
	public void Test() throws IOException {
		for(int i=0;i<C3.rowLength;i++) {
			...
			if(mediaMarketObjects.innerTextmarca(driver)!=null) {
				innerTextmarca=mediaMarketObjects.innerTextmarca(driver).getText();
			}
			else {
				innerTextmarca=mediaMarketObjects.innerTextmarca(driver).getText();
			}
			if(mediaMarketObjects.innerTextnombre(driver)!=null) {
				innerTextnombre=mediaMarketObjects.innerTextnombre(driver).getText();
			}
			else {
				innerTextnombre="Not Found from element";
			}
			if(mediaMarketObjects.innerTextprice(driver)!=null) {
				innerTextprice=mediaMarketObjects.innerTextprice(driver).getText();
			}
			else {
				innerTextprice="Not Found from element";
			}
			if(mediaMarketObjects.innerTextean(driver)!=null) {
				innerTextean=mediaMarketObjects.innerTextean(driver).getText();
			}
			else {
				innerTextean="Not Found from element";
			}
			if(mediaMarketObjects.availabilityCheck(driver)!=null) {
				Availabilityflag=mediaMarketObjects.availabilityCheck(driver);
			}
			else {
